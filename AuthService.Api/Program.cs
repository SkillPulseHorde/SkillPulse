...
builder.Services.AddAuthentication("Bearer").AddJwtBearer(options => {
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidateLifetime = true, // TODO если токен станет не валидным во время его передачи
...
app.MapPost("/api/auth/register", async ([FromBody] RegisterRequest request, IMediator mediator, CancellationToken ct) =>
{
